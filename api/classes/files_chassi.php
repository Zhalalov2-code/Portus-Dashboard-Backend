...
class files_chassi
{
    ...
    function getFiles()
    {
        try {
            ...
            $sql = "SELECT * FROM files_chassi WHERE id_message = :id_message";
    ...
    function postFiles()
    {
        try {
            ...
            // ИСПРАВЛЕНО: работаем с $_FILES['file_name'] напрямую
            ...
            $target_dir = __DIR__ . "/../uploads/chassi/";
            ...
            $sql = "INSERT INTO files_chassi (id_message, file_name) VALUES (:id_message, :file_name)";
            $stmt = $this->db->prepare($sql);
            $stmt->bindValue(':id_message', $this->id_message, PDO::PARAM_INT);
    ...
    function deleteFiles()
    {
        try {
            ...
            $sql_select = "SELECT file_name FROM files_chassi WHERE id_files = :id_files";
            ...
            $sql = "DELETE FROM files_chassi WHERE id_files = :id_files";
            $stmt = $this->db->prepare($sql);
